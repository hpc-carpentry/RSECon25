\begin{frame}{Where does HPC Carpentry fit?}
	\begin{enumerate}
		\item Knowing about Git and programming does not quite solve all problems
		\item Scientific computing researchers are usually not prepared for running stuff on a cluster. We can fix this using carpentry style pedagogy.
		teach
		\begin{itemize}
